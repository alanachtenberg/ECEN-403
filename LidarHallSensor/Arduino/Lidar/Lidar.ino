...
void setup()
{
  ...
  void loop()
  {
    ...
    if (values_read > 5 && values_read!=old_values_read)//first 4 values averaged are inccorect(array filled with zeros) because we need 5 measurements
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  void TC7_Handler()
  {
    ...
    for (int i=0;i<BUFF_SIZE-1;++i){//shift all values in buffer left
      time_buff[i]=time_buff[i+1];
      lidar_distance[i]=lidar_distance[i+1];
    }  
    //assign new values to end of buffer
